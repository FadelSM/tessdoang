...
const Schedule = () => {
    ...
    piketGroup = [
        ["Elba", "Abi", "Rizky", "Ezky", "Gangga", "Bagus", "Okta"],
        ["Jenar", "Rasta", "Fadel", "Saskia", "Mandala", "Erlangga", "Fikri"],
        ["Indra", "Aurel", "Zamzami", "Devika", "Daffa", "Aliya", "Zalfa"],
        ["Firdaus", "Safwan", "Kansa", "Kayla", "Renita", "Luthfia", "Yogi"],
        ["Fadhil", "Aldo", "Nabilla", "Konsa", "Ali", "Faqih"],
    ]
