	...
	return (
		<>
			...
			<div className=" flex justify-between py-[0.50rem] w-72 px-3 opacity-60" data-aos="fade-up" data-aos-duration="600">
					...
					<div className="flex justify-center items-center text-sm">08.30-09.30</div>
				</div>
			<div
			...
			<div
				...
				<div className="w-[50%] text-base  font-medium">Pendidikan Agama</div>
			...
			<div
				...
				<div className="flex justify-center items-center text-sm">12.20-14.50</div>
			</div>
		</>
	)
}
